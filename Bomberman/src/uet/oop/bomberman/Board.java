...
public class Board implements IRender {
	...
	public void nextLevel() {
            if (_levelLoader.getLevel() < 5){
                _game.ostGame.StopAudio();
                String path = "Level" + (_levelLoader.getLevel() + 1) + ".wav"; 
                _game.ostGame = new Audios(path, true); 
	...
	public void loadLevel(int level) {
		...
		_bombs.clear();
		_messages.clear();
                // xet lap cho nhac nen. 
                _game.ostGame.MainClip.loop(Clip.LOOP_CONTINUOUSLY);
